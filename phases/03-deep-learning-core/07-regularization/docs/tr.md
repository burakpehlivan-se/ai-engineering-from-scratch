...
Her model, yetersiz uyum (underfitting — deseni yakalamak için çok basit) ile aşırı uyum (overfitting — gürültüyü yakalayacak kadar karmaşık) arasında bir spektrumda yer alır. Düzenleme, modelleri aşırı uyum tarafından bu orta noktaya iter.
